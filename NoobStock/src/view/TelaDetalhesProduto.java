...
public class TelaDetalhesProduto extends JPanel {
	...
	public TelaDetalhesProduto() {
		...
		setLayout(new MigLayout("", "[][][grow 10][][grow][grow][][grow][grow 3][][grow][]", "[][][][grow][][][][][grow][grow 1][grow 1][grow 1][grow][][]"));
		...
		lblNewLabel_14_2.setBounds(33, 36, 87, 14);
		...
		lblNewLabel_14_2_1.setBounds(33, 66, 87, 14);
		...
		lblNewLabel_14_2_2.setBounds(33, 102, 87, 14);
		...
		lblNewLabel_14_2_3.setBounds(207, 36, 87, 14);
		...
		lblNewLabel_14_2_3_1.setBounds(217, 66, 87, 14);
		...
		lblNewLabel_14_2_3_2.setBounds(207, 102, 87, 14);
		...
		add(panel_2_1_1, "cell 7 8 4 7,grow");
		...
		lblNewLabel_21.setBounds(10, 72, 284, 14);
	...
	public void TelaDetalhesProduto2() {
		setBackground(new Color(255, 255, 255));
		setLayout(new MigLayout("", "[][][grow 10][][grow][grow][][grow 3][][grow][]", "[][][][grow][][][][][grow][grow 1][grow 1][grow 1][grow][][]"));
