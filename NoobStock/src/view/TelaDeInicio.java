...
public class TelaDeInicio extends JPanel {
	...
	public TelaDeInicio() throws IOException {
		...
		// PADRÃO: Layout com margem e espaçamento bem definidos
		setLayout(new MigLayout("insets 20, gap 15px 15px", "[40px:n][135px:n][][20px:n][][grow]", "[40px:n][35px:n][35px:n][35px:n][35px:n][35px:n][grow][][][][]"));

		lblPerfil = new JLabel("");
		lblPerfil.setIcon(new ImageIcon(TelaDeInicio.class.getResource("/img/image8.png")));
		add(lblPerfil, "cell 1 0, alignx center");
		...
		separator.setForeground(new Color(220, 220, 220)); // Cor mais suave
		separator.setOrientation(SwingConstants.VERTICAL);
		add(separator, "cell 2 0 1 11,gapx 10 10,growy");
		...
		ImageIcon icon = new ImageIcon(TelaDeInicio.class.getResource("/img/logopng.png"));
		// PADRÃO: Logo do menu lateral em 120x50
		Image imgRedimensionada = icon.getImage().getScaledInstance(120, 50, Image.SCALE_SMOOTH);
