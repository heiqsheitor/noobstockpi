...
public class TelaSaida extends JPanel {
	...
	public String getObservacao() {
		return txtAreaObservacao.getText().trim();
	}
	...
	public void adicionarItemNaTabela(ItemSaida item) {
		...
		tableModel.addRow(new Object[] { p.getNome(), p.getSKU(), item.getQuantidade(), p.getQtd() });
	}
	...
	public void setAdicionarAcao(ActionListener a) {
		btnAdicionar.addActionListener(a);
	}

	public void setConfirmarAcao(ActionListener a) {
		btnConfirmar.addActionListener(a);
	}

	public void setCancelarAcao(ActionListener a) {
		btnCancelar.addActionListener(a);
	}

	public void setRemoverAcao(ActionListener a) {
		btnRemover.addActionListener(a);
	}

	public void setInicio(Runnable acao) {
		ComponentUtils.transformarEmLink(LInicio, acao);
	}

	public void setEstoque(Runnable acao) {
		ComponentUtils.transformarEmLink(LEstoque, acao);
	}

	public void setFornecedor(Runnable acao) {
		ComponentUtils.transformarEmLink(LFor, acao);
	}

	public void setSaida(Runnable acao) {
		ComponentUtils.transformarEmLink(LSaida, acao);
	}
