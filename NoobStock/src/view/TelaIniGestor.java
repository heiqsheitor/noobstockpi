...
public class TelaIniGestor extends JPanel {
	 ...
	 * Create the panel.
	 */
	public TelaIniGestor() {
		setBackground(new Color(255, 255, 255));
		setLayout(new MigLayout("", "[][grow 10][][grow 3][][grow][]", "[][][][][][][grow 50][][]"));
		...
		lblNewLabel_10.setIcon(new ImageIcon(TelaIniGestor.class.getResource("/img/noobstocklogo(1)5 (1).png")));
		add(lblNewLabel_10, "cell 0 8,alignx center");
