...
/**
 * Diálogo modal exibido após o registro bem-sucedido de uma saída.
 * Mostra o comprovante formatado e permite baixar como arquivo HTML.
 */
public class TelaComprovante extends JDialog {
    ...
    private void construirInterface() {
        ...
        // ── Área do comprovante (JEditorPane com HTML) ───────────────────────
        ...
        // Volta o scroll ao topo após renderizar
    ...
    // ════════════════════════════════════════════════════════════════════════
    //  Geração do HTML do comprovante
    // ════════════════════════════════════════════════════════════════════════
    ...
    private String gerarHtml() {
        ...
        sb.append("<div class='header'>")
          .append("<div class='logo'>NoobStock</div>")
          .append("<div class='titulo-doc'>Comprovante de Saída de Estoque</div>")
          .append("</div>");
        ...
        sb.append("<div class='info-row'>")
          ...
          .append("<span class='badge'>Conclu&#237;da</span>")
          .append("</div>");
        sb.append("</div>");
        ...
        sb.append("<table>")
          .append("<thead><tr>")
          .append("<th>Produto</th><th>SKU</th><th>Quantidade</th>")
          .append("</tr></thead><tbody>");

        int totalUnidades = 0;
        for (ItemSaida item : saida.getItens()) {
            sb.append("<tr>")
              .append("<td>").append(esc(item.getProduto().getNome())).append("</td>")
              .append("<td>").append(esc(item.getProduto().getSKU())).append("</td>")
              .append("<td>").append(item.getQuantidade()).append(" un.</td>")
              .append("</tr>");
        ...
        sb.append("<div class='total-box'>")
          .append("<span class='total-label'>Total de unidades enviadas: </span>")
          .append("<span class='total-valor'>").append(totalUnidades).append("</span>")
          .append("</div>");

        // ── Rodapé ────────────────────────────────────────────────────────────
        sb.append("<div class='footer'>")
          .append("Documento gerado automaticamente pelo sistema NoobStock &bull; ")
    ...
    /** Utilitário: cria uma linha de informação no HTML. */
    private void infoRow(StringBuilder sb, String label, String valor) {
        sb.append("<div class='info-row'>")
          .append("<span class='info-label'>").append(label).append("</span>")
          .append("<span>").append(esc(valor)).append("</span>")
          .append("</div>");
    }

    /** Escapa caracteres especiais HTML para evitar quebra no JEditorPane. */
    ...
    private void baixarComprovante() {
        ...
        // Nome sugerido com o número da saída
        ...
        try (BufferedWriter writer = new BufferedWriter(
            ...
            // Abre o arquivo no navegador padrão do sistema (opcional)
            try {
