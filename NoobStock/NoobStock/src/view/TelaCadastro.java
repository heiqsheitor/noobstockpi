...
public class TelaCadastro extends JPanel {
	...
	public TelaCadastro() throws IOException{
		...
		setLayout(new MigLayout("insets 20, gap 10px 15px", "[grow 29][grow 0][grow 2][grow 3][grow 2][grow 29]", "[grow 40][][][][][][][][][][grow 35][grow 1]"));
	...
	public void ajustarFonte(int largura, int altura) {} // Mantido para compatibilidade
	
	public String getNome() { return this.tfUsuario.getText(); }
	public String getEmail() { return this.tfEmail.getText(); }
	public String getSenha() { return new String(this.pfSenha.getPassword()); }
	public void Cadastrar(ActionListener actionListener) { this.btnCadastrar.addActionListener(actionListener); }
